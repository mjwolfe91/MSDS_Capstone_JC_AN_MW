...
The three primary techniques leveraged in our model are Acceleration Vector Changes, K-Means Clustering, and Support Vector Machines.
...
K-means clustering is an unsupervised learning technique. We are using this to create labels for our dataset.

Support Vector Machines are a supervised machine learning technique wherein, given a 2D feature space, a hyperplane (also known as a decision boundary), is defined which separates one class from another.
