...
\section{Data}
    ...
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 1.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 2.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 3.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 4.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 5.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 6.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 7.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 8.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 9.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 10.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S1 - Activity 11.png}
    
    
    Angular Velocity
    
    
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 1.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 2.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 3.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 4.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 5.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 6.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 7.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 8.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 9.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 10.png}
    \includegraphics[width=3cm, height=4cm]{Draft1/images/S2 - Activity 11.png}
