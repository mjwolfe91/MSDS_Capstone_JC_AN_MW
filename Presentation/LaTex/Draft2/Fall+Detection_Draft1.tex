...
Subject 3 is the only left-handed participant in the study.
...
\begin{table}
\caption{Description of Activities Performed by Each Subject.}\label{table2}
\begin{center}
...
\end{table}
    ...
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 1.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 2.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 3.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 4.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 5.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 6.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 7.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 8.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 9.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 10.png}
    \includegraphics[width=3cm, height=4cm]{images/S1 - Activity 11.png}
    
    
    Angular Velocity
    
    
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 1.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 2.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 3.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 4.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 5.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 6.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 7.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 8.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 9.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 10.png}
    \includegraphics[width=3cm, height=4cm]{images/S2 - Activity 11.png}
